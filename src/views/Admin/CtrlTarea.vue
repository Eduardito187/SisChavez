<template>
  <div id="appC">
    <a-button type="danger" style="position:absolute;left:5px;bottom:90px;z-index:1000;" @click="swipeLeft" icon="left" />
...
<script>
import Carta from "./../Tarea/Carta.vue";
...
export default {
    ...
    data() {
        return {
        c: true,
        consulta: gql`query tarea($ID: Int!) {
                tarea(ID: $ID) {
                    ID
                    Codigo
                    Detalle
